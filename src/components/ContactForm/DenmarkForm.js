...
class DenmarkForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											...
											<option value="Copenhagen University">Copenhagen University</option>
											<option value="Technical University of Denmark.">Technical University of Denmark.</option>
