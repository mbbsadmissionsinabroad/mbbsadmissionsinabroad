...
class NepalForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Kathmandu University School of Medical Sciences (KUSMS)">Kathmandu University School of Medical Sciences (KUSMS)</option>
											<option value="B.P. Koirala Institute of Health Sciences (BPKIHS), Nepal">B.P. Koirala Institute of Health Sciences (BPKIHS), Nepal</option>
											<option value="Institute of Medicine (IOM) in Maharajgunj">Institute of Medicine (IOM) in Maharajgunj</option>
											<option value="Patan Academy of Health Sciences">Patan Academy of Health Sciences</option>
											<option value="Manipal College of Medical Sciences, Pokhara">Manipal College of Medical Sciences, Pokhara</option>
                    </Form.Control>
                </div>
                <div className="form-group">
