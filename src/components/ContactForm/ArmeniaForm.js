...
class ArmeniaForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="St Theresas Medical University, Armenia">St Theresas Medical University, Armenia</option>
											<option value="University of Traditional Medicine Study, Armenia">University of Traditional Medicine Study, Armenia</option>
											<option value="Haybusak University of Yerevan, Armenia">Haybusak University of Yerevan, Armenia</option>
											<option value="Yerevan State Medical University, Armenia">Yerevan State Medical University, Armenia</option>
											<option value="Armenina Medical Institute, Armenia">Armenina Medical Institute, Armenia</option>
                    </Form.Control>
                </div>
                <div className="form-group">
