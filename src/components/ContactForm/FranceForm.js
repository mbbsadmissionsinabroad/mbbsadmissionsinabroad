...
class FranceForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="University of Catholique De Lille, France">University of Catholique De Lille, France</option>
											<option value="University of Paris Sud">University of Paris Sud</option>
											<option value="Sorbbone Univerity">Sorbbone Univerity</option>
											<option value="University of Aix Marseille">University of Aix Marseille</option>
											<option value="University De Lyon">University De Lyon</option>
											<option value="PSL Research University Paris">PSL Research University Paris</option>
											<option value="University De Lorraine">University De Lorraine</option>
                    </Form.Control>
                </div>
                <div className="form-group">
