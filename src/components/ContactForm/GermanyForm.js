...
class GermanyForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Humboldt University">Humboldt University</option>
											<option value="Philipps University">Philipps University</option>
											<option value="University Heidelburg">University Heidelburg</option>
											<option value="Lubeck University">Lubeck University</option>
											<option value="Rwth Aachen University">Rwth Aachen University</option>
											<option value="Magdeburg University">Magdeburg University</option>
											<option value="Munster University">Munster University</option>
											<option value="Wurzburg University">Wurzburg University</option>
											<option value="Tubingen University">Tubingen University</option>
											<option value="Freiburg University">Freiburg University</option>
											<option value="Witten/Hercke University">Witten/Hercke University</option>
											<option value="Albert Ludwing’s Universitat Freiburg">Albert Ludwing’s Universitat Freiburg</option>
                    </Form.Control>
                </div>
                <div className="form-group">
