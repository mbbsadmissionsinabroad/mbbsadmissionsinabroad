...
class KyrgyzstanForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Asian Medical Institute">Asian Medical Institute</option>
											<option value="I.K.AKHUNBAEV KYRGYZ STATE MEDICAL ACADEMY">I.K.AKHUNBAEV KYRGYZ STATE MEDICAL ACADEMY</option>
											<option value="International University of Kyrgyzstan, International School of Medicine, Bishkek">International University of Kyrgyzstan, International School of Medicine, Bishkek</option>
											<option value="Jalal-Abad State University, Jalal-Abad">Jalal-Abad State University, Jalal-Abad</option>
											<option value="Kyrgyz Russian Slavic University">Kyrgyz Russian Slavic University</option>
											<option value="Kyrgyz State Medical Academy">Kyrgyz State Medical Academy</option>
											<option value="Osh State University, Medical Faculty">Osh State University, Medical Faculty</option>
                    </Form.Control>
                </div>
                <div className="form-group">
