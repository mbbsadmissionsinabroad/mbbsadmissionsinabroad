...
class BelizeForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Central America Health Sciences University">Central America Health Sciences University</option>
											<option value="Columbus Central University School of Medicine">Columbus Central University School of Medicine</option>
											<option value="Washington University of Health & Science">Washington University of Health & Science</option>
                    </Form.Control>
                </div>
                <div className="form-group">
