...
class LithuaniaForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Lithuanian University of Health Science Kaunas">Lithuanian University of Health Science Kaunas</option>
											...
											<option value="Vytautas Magnus University">Vytautas Magnus University</option>
											<option value="Klaipeda University">Klaipeda University</option>
											<option value="Siauliai University">Siauliai University</option>
											<option value="Mykolas Romeris University">Mykolas Romeris University</option>
                    </Form.Control>
                </div>
                <div className="form-group">
