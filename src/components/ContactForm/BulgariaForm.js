...
class BulgariaForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											...
											<option value="Sofia Medical University">Sofia Medical University</option>
											<option value="Varna Medical University">Varna Medical University</option>
											<option value="Pleven Medical University">Pleven Medical University</option>
                    </Form.Control>
                </div>
                <div className="form-group">
