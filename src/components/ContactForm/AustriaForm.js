...
class AustriaForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											<option value="Medical University of Vienna.">Medical University of Vienna.</option>
											<option value="Medical University of Graz.">Medical University of Graz.</option>
											<option value="Medical University of Innsbruck.">Medical University of Innsbruck.</option>
											<option value="Paracelsus Private Medical University.">Paracelsus Private Medical University.</option>
                    </Form.Control>
                </div>
                <div className="form-group">
