...
class FinlandForm extends React.Component {
              ...
              <form id="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
                ...
                <div className="form-group">
                    ...
                    <Form.Control as="select" value={this.state.option} onChange={this.onOptionChange.bind(this)} required>
											...
											<option value="University of Oulu">University of Oulu</option>
											<option value="University of Turku">University of Turku</option>
											<option value="University of Eastern Finland">University of Eastern Finland</option>
											<option value="LUT University">LUT University</option>
											<option value="University of Jyväskylä">University of Jyväskylä</option>
											<option value="Abo Akademi University">Abo Akademi University</option>
											<option value="Lappeenranta University of Technology">Lappeenranta University of Technology</option>
                    </Form.Control>
                </div>
                <div className="form-group">
