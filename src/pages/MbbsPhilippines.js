...
function MbbsPhilippines() {
  ...
  const meta = {
    ...
    description: 'MBBS Admission in Philippines. Destinex provides all guidance & assistance to Indian Students for Admission in Philippines MCI Approved Medical College.',
      ...
      <Container>
        ...
        <div id="problems_sec">
          ...
          <p className="service__info">
						...
						Therefore, the student should consult Destinex for any information regarding <b>MBBS Admission in Philippines</b>. We provide transparent information to the students so that they fulfill their wish to pursue <b>MBBS in Philippines</b> in the English-taught universities with reasonable and accurate fees.
          </p>
        </div>
        <div id="reserve_sec">
          <h6 className="service__sub__title">
						How reserve your MBBS Seat in Philippines for 2020 Admission
          </h6>
          <p className="service__info">
						Destinex help the students at each step in order to reserve the MBBS Seat in the Philippines for 2020 Admission
            <ul>
        ...
        <div id="charges_sec">
          <h6 className="service__sub__title">
            Service & Consultancy Charges of Destinex
					...
					<p className="service__info">
						Destinex is one of the best overseas education consultants in India. We have already placed hundreds of Indian students in Philippines for pursuing MBBS course in the top medical universities that taught MBBS course in English language.<br/><br/>
        ...
        <div id="destinex_sec">
          <h6 className="service__sub__title">
						Applying <b>MBBS in Philippines</b> from Destinex, the students have the following benefits:
          </h6>
          <p className="service__info">
						<ul>
