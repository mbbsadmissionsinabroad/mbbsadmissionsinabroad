      ...
      <Container>
        <div>
          <ul className="hyperlink">
            ...
            <li><a href="#university_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Top Universities to Study MBBS in Nepal </a></li>
						<li><a href="#requirements_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Requirements for MBBS Admission in Nepal {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} </a></li>
            <li><a href="#visa_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Visa Procedure for MBBS in Nepal </a></li>
						...
						<li><a href="#reserve_sec"><img src="/assets/icon.png" alt="Left Arrow" /> How reserve your MBBS Seat in Nepal for {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} Admission </a></li>
        ...
        <div id="requirements_sec">
          <h5 className="service__sub__title">
						Requirements for MBBS Admission in Nepal {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}
          </h5>
        ...
        <div id="reserve_sec">
          <h6 className="service__sub__title">
						How to reserve your MBBS Seat in Nepal for {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} Admission
          </h6>
