      ...
      <Container>
        <div>
          ...
          <ul className="hyperlink">
            ...
            <li>
              <a href="#about_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> About Kazakhstan
              </a>
            </li>
            <li>
              <a href="#why_mbbs_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Why MBBS Study in Kazakhstan
              </a>
            </li>
            <li>
              <a href="#benefits_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Benefits of MBBS in Kazakhstan for Indian Students 2020
              </a>
            </li>
            <li>
              <a href="#university_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Top Universities for MBBS in Kazakhstan
              </a>
            </li>
            <li>
              <a href="#requirements_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Requirements for MBBS Admission in Kazakhstan 2020-2021
              </a>
            </li>
            <li>
              <a href="#advice_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> MBBS in Kazakhstan Advice for Indian students
              </a>
            </li>
            <li>
              <a href="#pros_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Pro & Cons of Studying MBBS in Kazakhstan
              </a>
            </li>
            <li>
              <a href="#visa_sec">
                <img src="/assets/left-arrow.png" alt="Left Arrow" /> Visa Procedure for MBBS in Kazakhstan
              </a>
            </li>
            <li>
              <a href="#faq_sec">
