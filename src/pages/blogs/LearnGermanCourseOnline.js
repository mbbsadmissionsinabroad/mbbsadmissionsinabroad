...
function LearnGermanCourseOnline() {
	const meta = {
    title: "German Language Course Online for Beginners",
    description: "German Language Course Online for Beginners without spending a lot of money. As everything becoming digital these days, you have a great opportunity to learn a German language on your own and at your own pace.",
    canonical: "https://www.mbbsadmissionsinabroad.com/german-language-course-online-for-beginners",
    meta: {
      charset: "utf-8",
      name: {
        keywords: "German Language Course Online for Beginners",
      },
    },
	};
    ...
    return ( 
        ...
        <div>
					<div className="service__bg">
						<h1 className="service__title">German Language Course Online for Beginners</h1>
					</div>
					<Container>
						<div className="blog__post__img">
						<img src="assets/images/blog-banners/german-online-course.png" alt="German Language Course Online for Beginners"/>
						</div>
						
						<ul className="hyperlink">
              <li><a href="#1"><img src="/assets/left-arrow.png" alt="Left Arrow" /> Why learn online German course? </a></li>
							<li><a href="#2"><img src="/assets/left-arrow.png" alt="Left Arrow" /> Ways to Learn German </a></li>
							<li><a href="#3"><img src="/assets/left-arrow.png" alt="Left Arrow" /> How long does learning German take? </a></li>
							<li><a href="#4"><img src="/assets/left-arrow.png" alt="Left Arrow" /> Similarities between the German and the English language </a></li>
					...
					<section className="blog__post">
						<Container>
							...
							<ul className="blog__post__list">
								...
								<li><img src="assets/right-direction.png" alt="Right Direction" /> More than 900-hour interactive online German course</li>
								<li><img src="assets/right-direction.png" alt="Right Direction" /> Exercises are structured as per the European framework of reference for languages</li>
								<li><img src="assets/right-direction.png" alt="Right Direction" /> Experts will answer your questions</li>
								<li><img src="assets/right-direction.png" alt="Right Direction" /> Provide clear explanations for each grammar point</li>
							</ul>

							{/*<img src="assets/images/banner-advertisement.png" alt="" /> */}
							
							<div id="1">
								<h2 className="blog__post__title">Why learn online German course?</h2>
								<p className="blog__post__desc">There are various benefits to learn <b>online German course</b> such as:</p>

								<ul className="blog__post__list">
									<li><img src="assets/right-direction.png" alt="Right Direction" /> You can build new connections with millions of people across the world</li>
									<li><img src="assets/right-direction.png" alt="Right Direction" /> You can get a leg up in learning about other related languages including English</li>
									<li><img src="assets/right-direction.png" alt="Right Direction" /> You can experience the culture and history of the German-speaking world</li>
									<li><img src="assets/right-direction.png" alt="Right Direction" /> You can make your German business skills that assist you to compete in the global economy</li>
									<li><img src="assets/right-direction.png" alt="Right Direction" /> You can travel to and even live in German-speaking countries with confidence</li>
								</ul>

							</div>
							
							<div id="2">
								<h3 className="blog__post__title">Ways to Learn German</h3>
								<p className="blog__post__desc"><b>Learning German in the classroom</b></p>

								<p className="blog__post__desc">German is among some of the most studied languages in school systems and universities around the world. <Link to="/learn-german-language-course-in-bangalore">Classroom learning</Link> is the most popular option for beginners in grade school or university. It enables more intensive, regular study with feedback from teachers who know the language and can correct mistakes as they happen and teach content in an interactive way.</p>
							...
							<div id="3">
								<h3 className="blog__post__title">How long does learning German take?</h3>
							...
							<div id="4">
								<h3 className="blog__post__title">Similarities between the German and the English language</h3>
...
export default LearnGermanCourseOnline;