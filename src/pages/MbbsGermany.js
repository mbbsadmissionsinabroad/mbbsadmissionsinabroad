      ...
      <Container>
        ...
        <div id="benefits_sec">
          <h3 className="service__sub__title">
						Benefits of Studying MBBS in Germany for Indian Students 2020
          </h3>
          <p className="service__info">
        ...
        <div id="requirements_sec">
          <h6 className="service__sub__title">
						Requirements for MBBS Admission in Germany 2020-2021
          </h6>
          <p className="service__info">
        ...
        <div id="fees_sec">
          <h6 className="service__sub__title">
						MBBS Fees in Germany 2020-2021
          </h6>
        ...
        <div id="reserve_sec">
          <h6 className="service__sub__title">
						How to reserve your MBBS Seat in Germany for 2020 Admission
          </h6>
          <p className="service__info">
          ...
          <Accordion defaultActiveKey="0">
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="5">
                <b className="accordion__title">What is the NEET minimum marks to join an MBBS in Germany 2020?</b>
              </Accordion.Toggle>
              <Accordion.Collapse eventKey="5">
                <Card.Body>
									<p className="service__info">The NEET minimum marks to join an MBBS in Germany 2020 is 50 percentile.</p>
                </Card.Body>
              </Accordion.Collapse>
            </Card>
          </Accordion>
