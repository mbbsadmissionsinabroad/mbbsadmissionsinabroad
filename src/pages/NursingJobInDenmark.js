    ...
    <section>
      ...
      <Container>
          ...
          <ul className="hyperlink">
						...
						<li><a href="#requirements_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Requirement of nurse’s vacancy in Denmark {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}</a></li>		
        ...
        <div id="vacancy_sec">
          ...
          <div id="requirements_sec">
            <h6 className="service__sub__title">Requirement of nurse’s vacancy in Denmark 2022 - 2023</h6>
