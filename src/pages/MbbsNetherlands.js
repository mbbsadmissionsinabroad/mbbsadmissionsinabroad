      ...
      <Container>
        <div>
          ...
          <ul className="hyperlink">
            ...
            <li><a href="#why_mbbs_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Why Study MBBS in Netherlands</a></li>
						<li><a href="#benefits_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Benefits of Studying MBBS in Netherlands for Indian Students {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}</a></li>
            ...
            <li><a href="#university_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Top Universities to Study MBBS in Netherlands </a></li>
						<li><a href="#requirements_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Requirements for MBBS Admission in Netherlands {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} </a></li>
						<li><a href="#fees_sec"><img src="/assets/icon.png" alt="Left Arrow" /> MBBS Fees in Netherlands {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} </a></li>
        ...
        <div id="benefits_sec">
          <h3 className="service__sub__title">
						Benefits of Studying MBBS in Netherlands for Indian Students {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}
          </h3>
          <p className="service__info">
        ...
        <div id="requirements_sec">
          <h6 className="service__sub__title">
						Requirements for MBBS Admission in Netherlands {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}
          </h6>
          <p className="service__info">
        ...
        <div id="fees_sec">
          <h6 className="service__sub__title">
						MBBS Fees in Netherlands {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}
          </h6>
          ...
          <Accordion defaultActiveKey="0">
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="5">
                <b className="accordion__title">What is the NEET minimum marks to join an MBBS in Netherland {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}?</b>
              </Accordion.Toggle>
              <Accordion.Collapse eventKey="5">
                <Card.Body>
									<p className="service__info">The NEET minimum marks to join an <b>MBBS in Netherlands</b> {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1} is 50 percentile.</p>
                </Card.Body>
              </Accordion.Collapse>
						</Card>
          </Accordion>
