        ...
        <div>
          ...
          <ul className="hyperlink">
            ...
            <li><a href="#why_mbbs_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Why Study MBBS in Bangladesh</a></li>
						<li><a href="#benefits_sec"><img src="/assets/icon.png" alt="Left Arrow" /> Benefits of Studying MBBS in Bangladesh for Indian Students {(new Date().getFullYear())} - {(new Date().getFullYear()) + 1}</a></li>
